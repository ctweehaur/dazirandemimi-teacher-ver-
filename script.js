// ==========================================================================
// ⚙️ 全互动式华文教学系统阅读器大脑 - script.js (深色模式全文本高亮对齐版)
// ==========================================================================
...
window.onload = function() {
    // 🌟 核心视觉修复：完美解决 image_237ea2.png 截图中深色模式下题目和文字变黑读不出的问题
    const style = document.createElement('style');
    style.innerHTML = `
        /* 当开启深色模式时，强制将所有题目文本、选项文本及正文字体渲染为高亮纯白 */
        [data-theme='dark'] #quizSection,
        [data-theme='dark'] #quizSection div,
        [data-theme='dark'] #quizSection span,
        [data-theme='dark'] #content,
        [data-theme='dark'] p {
            color: #ffffff !important;
        }
        
        /* 让选择题的卡片卡槽在深色模式下具有极高对比度，底色采用深海蓝灰，文字全白 */
